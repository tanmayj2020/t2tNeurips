...
class MaskedAutoencoderViT(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3,
                 embed_dim=1024, depth=24, num_heads=16,tokens_type='performer' , token_dim=64
...
def t2t_neurips_(**kwargs):
    model = MaskedAutoencoderViT(embed_dim = 384 , depth = 14 , num_heads=6,mlp_ratio=3.0,token_dim=64,
     decoder_embed_dim=128, decoder_depth=2, decoder_num_heads=16,
